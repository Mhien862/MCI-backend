...
export declare class Mark<Options = any, Storage = any> {
    ...
    extend<ExtendedOptions = Options, ExtendedStorage = Storage>(extendedConfig?: Partial<MarkConfig<Partial<ExtendedOptions>, Partial<ExtendedStorage>>>): Mark<ExtendedOptions, ExtendedStorage>;
