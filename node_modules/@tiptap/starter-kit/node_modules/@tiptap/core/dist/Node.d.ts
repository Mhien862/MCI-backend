...
export declare class Node<Options = any, Storage = any> {
    ...
    extend<ExtendedOptions = Options, ExtendedStorage = Storage>(extendedConfig?: Partial<NodeConfig<Partial<ExtendedOptions>, Partial<ExtendedStorage>>>): Node<ExtendedOptions, ExtendedStorage>;
}
