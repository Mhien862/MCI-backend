...
export declare class Extension<Options = any, Storage = any> {
    ...
    extend<ExtendedOptions = Options, ExtendedStorage = Storage>(extendedConfig?: Partial<ExtensionConfig<Partial<ExtendedOptions>, Partial<ExtendedStorage>>>): Extension<ExtendedOptions, ExtendedStorage>;
}
